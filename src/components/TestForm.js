...
<div className="mb-3" >
  <textarea className="form-control" style={{backgroundColor:props.mode==="dark"?"#30356a":"light",color:props.mode==="dark"?"white":"#0b1d53"}}  value={text}  onChange={handleOnChange} id="myBox" rows="8"></textarea>
</div>
